...
@implementation CSThreadSafeDictionary{
...
- (BOOL)isEqualToDictionary:(NSDictionary *)otherDictionary {
    ...
    if ([otherDictionary isKindOfClass:CSThreadSafeDictionary.class]) {
        CSThreadSafeDictionary *other = (id)otherDictionary;
        BOOL isEqual;
...
- (BOOL)isEqual:(id)object {
    ...
    if ([object isKindOfClass:CSThreadSafeDictionary.class]) {
        CSThreadSafeDictionary *other = object;
        BOOL isEqual;
        dispatch_semaphore_wait(_lock, DISPATCH_TIME_FOREVER);
        dispatch_semaphore_wait(other->_lock, DISPATCH_TIME_FOREVER);
        isEqual = [_dic isEqual:other->_dic];
