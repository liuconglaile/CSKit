...
@interface _CSTextMagnifierCaret : CSTextMagnifier {
    UIImageView *_contentView;
    UIImageView *_coverView;
}
@end

@implementation _CSTextMagnifierCaret
...
- (CSTextMagnifierType)type {
    return CSTextMagnifierTypeCaret;
}
...
@interface _CSTextMagnifierRanged : CSTextMagnifier {
    UIImageView *_contentView;
    UIImageView *_coverView;
}
@end
...
@implementation _CSTextMagnifierRanged
#define kMultiple 1.2
...
- (CSTextMagnifierType)type {
    return CSTextMagnifierTypeRanged;
}
...
@implementation CSTextMagnifier

+ (id)magnifierWithType:(CSTextMagnifierType)type {
    switch (type) {
        case CSTextMagnifierTypeCaret :return [_CSTextMagnifierCaret new];
        case CSTextMagnifierTypeRanged :return [_CSTextMagnifierRanged new];
    }
    return nil;
}
...
- (id)initWithFrame:(CGRect)frame {
    // class cluster
    if ([self isMemberOfClass:[CSTextMagnifier class]]) {
        ///用一个具体的子类,而不是试图实例化一个抽象类
