...
@implementation CSTextContainerView
{
...
- (void)setLayout:(CSTextLayout *)layout {
...
- (void)setLayout:(CSTextLayout *)layout withFadeDuration:(NSTimeInterval)fadeDuration {
...
- (void)drawRect:(CGRect)rect {
    ...
    if (_attachmentChanged) {
        ...
        for (CSTextAttachment *a in _layout.attachments) {
