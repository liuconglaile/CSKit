...
/**
 The CSTextViewDelegate protocol defines a set of optional methods you can use
 to receive editing-related messages for CSTextView objects.
 ...
 */
@protocol CSTextViewDelegate <NSObject, UIScrollViewDelegate>
@optional
- (BOOL)textViewShouldBeginEditing:(CSTextView *)textView;
- (BOOL)textViewShouldEndEditing:(CSTextView *)textView;
- (void)textViewDidBeginEditing:(CSTextView *)textView;
- (void)textViewDidEndEditing:(CSTextView *)textView;
- (BOOL)textView:(CSTextView *)textView shouldChangeTextInRange:(NSRange)range replacementText:(NSString *)text;
- (void)textViewDidChange:(CSTextView *)textView;
- (void)textViewDidChangeSelection:(CSTextView *)textView;

- (BOOL)textView:(CSTextView *)textView shouldTapHighlight:(CSTextHighlight *)highlight inRange:(NSRange)characterRange;
- (void)textView:(CSTextView *)textView didTapHighlight:(CSTextHighlight *)highlight inRange:(NSRange)characterRange rect:(CGRect)rect;
- (BOOL)textView:(CSTextView *)textView shouldLongPressHighlight:(CSTextHighlight *)highlight inRange:(NSRange)characterRange;
- (void)textView:(CSTextView *)textView didLongPressHighlight:(CSTextHighlight *)highlight inRange:(NSRange)characterRange rect:(CGRect)rect;
@end
...
/**
 The CSTextView class implements the behavior for a scrollable, multiline text region.
 ...
 * It allows to set an attributed text as placeholder.
 ...
 See NSAttributedString+CSText.h for more convenience methods to set the attributes.
 See CSTextAttribute.h and CSTextLayout.h for more information.
 */
@interface CSTextView : UIScrollView
<UITextInput>
...
@property (nullable, nonatomic, weak) id<CSTextViewDelegate> delegate;
...
/**
 The text vertical aligmnent in container. Default is CSTextVerticalAlignmentTop.
 */
 ...
 */
@property (nullable, nonatomic, strong, readonly) CSTextLayout *textLayout;
...
IB_DESIGNABLE
@interface CSTextView : UIScrollView <UITextInput>
...
@property (nonatomic) IBInspectable CSTextVerticalAlignment textVerticalAlignment;
...
UIKIT_EXTERN NSString *const CSTextViewTextDidBeginEditingNotification;
UIKIT_EXTERN NSString *const CSTextViewTextDidChangeNotification;
UIKIT_EXTERN NSString *const CSTextViewTextDidEndEditingNotification;
