...
@implementation CALayer (CSWebImage)
...
- (void)setImageWithURL:(NSURL *)imageURL
    ...
    dispatch_async_on_main_queue(^{
        if ((options & CSWebImageOptionSetImageWithFadeAnimation) &&
            ...
            [self removeAnimationForKey:_CSWebImageFadeAnimationKey];
        }
        ...
        dispatch_async([_CSWebImageSetter setterQueue], ^{
            ...
            CSWebImageCompletionBlock _completion = ^(UIImage *image, NSURL *url, CSWebImageFromType from, CSWebImageStage stage, NSError *error) {
                ...
                BOOL showFade = (options & CSWebImageOptionSetImageWithFadeAnimation);
                dispatch_async(dispatch_get_main_queue(), ^{
                    ...
                    if (setImage && self && !sentinelChanged) {
                        if (showFade) {
                            ...
                            [self addAnimation:transition forKey:_CSWebImageFadeAnimationKey];
                        }
